...
namespace UTJ
{
    public class SpringManager : MonoBehaviour
    {
        ...
        [Header("LOD Support")]
        public AnimationLODSupporter lodSupporter;
        ...
        public void UpdateDynamics()
        {
            ...
            if (lodSupporter != null && lodSupporter.IsValid())
            {
                lodIndex = lodSupporter.QueryCurrentLODLevel();
                resetSmoothDrag = timeStep * lodSupporter.lodCrossFadeSmoothDrag;
            }
